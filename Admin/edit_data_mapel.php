    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Edit Data Mata Pelajaran</div>
        </div>
        <div class="container">
            <div class="container">
  ...
  <form action="proses-edit-mapel.php" method="POST" >
    <div class="row">
        ...
        <div class="form-group">
          ...
          <input type="hidden" class="form-control" name="id_mapel" value="<?php echo $hasil['id_mapel']; ?>">
          <input type="text" class="form-control" name="nama" placeholder="Nama Mata Pelajaran" style="width: 250px" value="<?php echo $hasil['nama']; ?>">
          <br>
